...
export default function CreateLeadForm({ onSubmit, onCancel, open }: CreateLeadFormProps) {
                ...
                >
                    ...
                    >
                       <div className="flex flex-col sm:flex-row justify-center items-center gap-4 sm:gap-[20px]">
                            ...
                            <Radio.Button
                                value="High"
                                className="w-full max-w-[144px] h-[32px] rounded-[8px] !flex !items-center !border !justify-center !gap-2"
                            >
